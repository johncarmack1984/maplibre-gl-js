...
- Skip texture bindings that are already in place, about a fifth of the WebGL calls of a frame with terrain ([#XXXX](https://github.com/maplibre/maplibre-gl-js/pull/XXXX))
