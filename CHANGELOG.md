...
- Tile source `bounds`, feature queries, image sources, terrain and hillshade follow a projection registered with `addProjection` ([#168](https://github.com/maplibre/maplibre-gl-js/issues/168))
