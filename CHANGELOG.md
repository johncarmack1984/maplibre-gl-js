...
- Tile source `bounds`, feature queries and image sources follow a projection registered with `addProjection` ([#168](https://github.com/maplibre/maplibre-gl-js/issues/168))
