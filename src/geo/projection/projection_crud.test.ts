...
describe('addProjection', () => {
    ...
    test('throws for a non-positive zoom 0 extent or meters per unit', () => {
        ...
        expect(() => addProjection({...createDefinition('test-crs'), metersPerUnit: 0})).toThrow(/metersPerUnit/);
        expect(() => addProjection({...createDefinition('test-crs'), metersPerUnit: -1})).toThrow(/metersPerUnit/);
