...
describe('Terrain in a planar projection', () => {
    ...
    test('finds tile 1/1/0 for 45,45 at zoom 1 with the projection, three quarters across and a quarter down the 16384 unit world', () => {
        ...
        expect(worldX).toBe(12288);
        expect(worldY).toBe(4096);
    });
