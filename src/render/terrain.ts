...
export class Terrain {
    ...
    /**
     * Calculates the height of the tile skirts for the "auto" strategy: a fifth of the tile width in meters at the
     * center of the world square, the equator for mercator.
     * @see {@link MapOptions.terrainSkirtLength}
    ...
    getSkirtLength(zoom: number): number {
        ...
        const worldWidthInMeters = this._worldCoordinateHelper.metersPerWorldUnit(0.5, 0.5);
